...
const updatePaymentGateway = async (apiData, user) => { 
    ...
    let existingRecords = await DBManager.getData("user_payment_gateway", '*', whereQry);
    if(existingRecords && existingRecords.length){
        console.log('Updating ', updateUserPaymentBody);
...
module.exports.handler = async function (event, context, callback) {
    try{
        ...
        response = { success: true, message: "Card Added."}
